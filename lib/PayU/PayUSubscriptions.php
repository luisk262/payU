...
use PayU\PayUBundle\lib\PayU\util\PayUSubscriptionsRequestUtil;
use PayU\PayUBundle\lib\PayU\api\RequestMethod;
use PayU\PayUBundle\lib\PayU\util\PayUSubscriptionsUrlResolver;
use PayU\PayUBundle\lib\PayU\util\PayUApiServiceUtil;
use PayU\PayUBundle\lib\PayU\exceptions\PayUException;
...
class PayUSubscriptions{
	 ...
	 * @return mixed The response to the request sent
	 ...
	 *
	 * @param array $parameters The parameters to be sent to the server
	 * @return mixed the finded Subscription
	 * @throws PayUException
	 * @throws InvalidArgumentException
	 */
