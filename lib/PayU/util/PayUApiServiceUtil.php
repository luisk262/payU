...
use PayU\PayUBundle\lib\PayU\api\PayUConfig;
use PayU\PayUBundle\lib\PayU\api\Environment;
use PayU\PayUBundle\lib\PayU\api\PayUResponseCode;
...
class PayUApiServiceUtil{
	 ...
	 * @param null $removeNullValues
	 * @return bool|mixed
	 * @throws PayUException
	 * @throws PayU\exceptions\ConnectionException
	 */
