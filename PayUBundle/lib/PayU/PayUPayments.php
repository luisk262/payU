...
namespace PayU\PayUBundle\lib\PayU;

use PayU\PayUBundle\lib\PayU\api\TransactionType;
use PayU\PayUBundle\lib\PayU\util\PayUParameters;
use PayU\PayUBundle\lib\PayU\util\CommonRequestUtil;
use PayU\PayUBundle\lib\PayU\util\RequestPaymentsUtil;
use PayU\PayUBundle\lib\PayU\api\PayUHttpRequestInfo;
use PayU\PayUBundle\lib\PayU\api\Environment;
use PayU\PayUBundle\lib\PayU\api\RequestMethod;
use PayU\PayUBundle\lib\PayU\util\PayUApiServiceUtil;
use PayU\PayUBundle\lib\PayU\api\PayUPaymentMethodType;
...
class PayUPayments{
	 ...
	 * @param string $lang language of request see SupportedLanguages class
	 * @return mixed The transaction response to the request sent
	 * @throws PayUException
	 * @throws InvalidArgumentException
	 * 
	 */
	 ...
	 *
	 * @param array $parameters The parameters to be sent to the server
	 * @param array $transactionType The type of the payment transaction
	 * @param string $lang language of request see SupportedLanguages class            
	 * @return mixed The transaction response to the request sent
	 * @throws PayUException
	 * @throws InvalidArgumentException
